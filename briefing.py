...
【重要なルール】
・必ず{date}前後24時間以内の最新ニュースをWeb検索して収集してください
・検索時は必ず日付（{date}）をキーワードに含めてください
・該当日の新しいニュースが見つからないカテゴリは潔くスキップしてください
・無理に古い情報や関係薄い情報で埋めないでください
・各ニュースには必ず記事URLをつけてください
・専門用語には（）でかんたんな解説をつけてください

【保険営業へのつなげ方について】
・「→ 保険営業的な意味：〇〇」のような一言まとめは禁止です
・ニュースの背景・文脈を丁寧に説明した上で、なぜそれが保険営業に関係するのかを3〜5文で論理的に説明してください
...
💡 **今日の支店訪問ネタ候補**（見つかったニュースの中から最大3つ、一言トーク例つき）

🔍 **Claudeコラム**（今日特に注目すべき点があれば）
